...
import introImage2 from '/src/assets/images/introContent/IntroContent2.webp';
import introImage3 from '/src/assets/images/introContent/IntroContent3.webp';
import introImage4 from '/src/assets/images/introContent/IntroContent4.webp';
...
export const INTRO_CONTENT_CONTENTS = Object.freeze({
  CONTENTS: [
    ...
    {
      title: '클리닝',
      element1: '보일러·소각로, 탱크·관로',
      element2: '고압세정, 화학세정, 건식세정',
      element3: '준설작업, 슬러지 CAKE 작업',
      element4: '활성탄·여재, 촉매 & GEL 교체 작업',
