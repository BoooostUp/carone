import homeImage1 from '/src/assets/images/mainArticle/carone.webp';
import homeImage2 from '/src/assets/images/mainArticle/ce.webp';
import homeImage3 from '/src/assets/images/es/esImage3.png';
import homeImage4 from '/src/assets/images/mainArticle/total.webp';
import homeImage5 from '/src/assets/images/hj/hjImage1.png';
import homeImage6 from '/src/assets/images/mainArticle/sg.webp';
...
export const MAIN_ARTICLE_CONTENTS = Object.freeze({
  HOME: [
    ...
    },
    {
      id: 'ES',
      title1: '(주) 에너지스토리',
      content1: `(주)에너지스토리는 폐유성페인트, 폐수성페인트, 폐유기용제 등을 파쇄·분쇄·정제하여 유기용제 및 재생연료로 재활용하는 액상폐기물 재활용 전문 기업입니다.`,
      imageAddress: homeImage3, // 실제 있는 이미지로 교체
    },
    {
      id: 'TOTAL',
      title1: '(주) 토탈',
    ...
    },
    {
      id: 'HJ',
      title1: '(주)황지',
      content1: `(주)황지는 울산시청 허가를 받아 사업장 일반폐기물 중 매립대상 폐기물을 안정적으로 처리하는 최종처분(매립) 전문 업체입니다.`,
      imageAddress: homeImage5, // 실제 있는 이미지로 교체
    },
    {
      id: 'SG',
      title1: '(주)에스지산업',
